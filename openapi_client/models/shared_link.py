...
class SharedLink(object):
    ...
    def __init__(self, id=None, expires_at=None, node_id=None, name=None, title=None, description=None, modified_at=None, modified_by_user=None, shared_by_user=None, content=None, allowable_operations=None, allowable_operations_on_target=None, is_favorite=None, properties=None, aspect_names=None, local_vars_configuration=None):  # noqa: E501
        """SharedLink - a model defined in OpenAPI"""  # noqa: E501
