...
class SiteMembershipRequestBodyCreate(object):
    ...
    def __init__(self, message=None, id=None, title=None, local_vars_configuration=None):  # noqa: E501
        """SiteMembershipRequestBodyCreate - a model defined in OpenAPI"""  # noqa: E501
