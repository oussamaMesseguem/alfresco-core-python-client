...
class Company(object):
    ...
    def __init__(self, organization=None, address1=None, address2=None, address3=None, postcode=None, telephone=None, fax=None, email=None, local_vars_configuration=None):  # noqa: E501
