...
class Version(object):
    ...
    def __init__(self, id=None, version_comment=None, name=None, node_type=None, is_folder=None, is_file=None, modified_at=None, modified_by_user=None, content=None, aspect_names=None, properties=None, local_vars_configuration=None):  # noqa: E501
