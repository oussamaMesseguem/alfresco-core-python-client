...
class ActivitiesApi(object):
    ...
    def list_activities_for_person_with_http_info(self, person_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ActivityPaging, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('person_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `person_id` when calling `list_activities_for_person`")  # noqa: E501

        if self.api_client.client_side_validation and 'skip_count' in local_var_params and local_var_params['skip_count'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `skip_count` when calling `list_activities_for_person`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'max_items' in local_var_params and local_var_params['max_items'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `max_items` when calling `list_activities_for_person`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        if 'who' in local_var_params and local_var_params['who'] is not None:  # noqa: E501
            query_params.append(('who', local_var_params['who']))  # noqa: E501
